      ...
      <div className="mb-8 flex justify-center gap-8 border-b">
        {[
          ...
          <button
            ...
            className={cn(
              "relative pb-4 text-sm font-medium transition-colors hover:text-indigo-500",
              {
                "text-indigo-500": activeTab === tab.id,
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        {products.map((product) => (
          ...
          >
            ...
            <div>
                    <h3 className="font-medium group-hover:text-indigo-500">
                {product.title}
              </h3>
